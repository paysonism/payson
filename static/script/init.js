lanyard({
    userId: "1168318957841817680",
}).then((response) => {
    document.getElementsByClassName("lanyard-profile-picture")[0].src = `https://cdn.discordapp.com/avatars/1168318957841817680/45afeddb1de9ecc9a14769a41bb57d89.webp`;
    var original_lanyard_username = document.getElementsByClassName("lanyard-username")[0].innerHTML;
    document.getElementsByClassName("lanyard-username")[0].innerHTML = `payson1337`;
    //try {
